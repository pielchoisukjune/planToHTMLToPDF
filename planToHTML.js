...
global.CONST.config.brandNm = "dralthea";
...
var reportSourcePath = "D:/workspace_piel/marketing_planning/brand/" + global.CONST.config.brandNm + "/"
var reportSourcefileNm = global.CONST.config.targetYear + pad( global.CONST.config.targetMonth, 2 ) + "_data.json"
var reportSourceThtmlFileNm = "./plan.thtml";
...
var savePath = global.CONST.config.curPath + "plan/" + global.CONST.config.brandNm + "/" + global.CONST.config.targetYear + pad( global.CONST.config.targetMonth, 2 ) + "/";
var saveFileNm = "plan_" + global.CONST.config.brandNm + "_" + global.CONST.config.targetYear + pad( global.CONST.config.targetMonth, 2 );
